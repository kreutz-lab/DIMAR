...
# if read.csv takes too long for big files try:
#  fread(filepath_evidence, select = c("Sequence", "Leading razor protein", "Modified sequence", "Experiment", "Intensity", "Modifications"))
# with select you can choose the columns you would like to keep

maxQuantToMatrix <- function(filename){
    # Read file
